 ...
 */
var array1: [String]=["Walk 8000 steps today", "Walk for 30 minutes today"]
var array2: [String]=["Run 4 kms today", "Run 2 kms twice a day"]
...
var challenges: [[String]]=[array1,array2]
...
if newArray.isEmpty{
    ...
    print("The challenge you have chosen is \(newArray[0])")
}
else{
