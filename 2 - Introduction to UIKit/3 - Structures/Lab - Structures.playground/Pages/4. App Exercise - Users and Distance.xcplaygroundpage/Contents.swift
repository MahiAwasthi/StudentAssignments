...
let Mahi: User = .init(name: "Mahi", age: 20, height: 1.59, weight: 62, activityLevel: 9)
print("My name is \(Mahi.name), I am \(Mahi.age) years old, I am \(Mahi.height) meters tall and I weigh \(Mahi.weight) kilograms. My activity level is \(Mahi.activityLevel)/10")
...
let otherDistance=Distance(meters: 120, feet: 3937)
