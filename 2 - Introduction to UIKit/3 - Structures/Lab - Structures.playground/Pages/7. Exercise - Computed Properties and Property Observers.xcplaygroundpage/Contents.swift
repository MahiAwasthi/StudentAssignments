...
struct Height {
    ...
    init(heightInInches: Double) {
        ...
        self.heightInCentimeters = heightInInches*2.54 //converting inches to cms
    }
    // for cm
    init(heightInCentimeters: Double) {
        self.heightInCentimeters = heightInCentimeters
        self.heightInInches = heightInCentimeters/2.54 //converting cms to inches
    }
}
var height1 = Height(heightInInches: 60)
print(height1.heightInCentimeters) //printing 60 in cm
var height2 = Height(heightInInches: 70)
