...
var secondRun = RunningWorkout(distance:2_396, time: 15.3, elevation: 94)
print("Distance: \(secondRun.distance) meters")
print("Time: \(secondRun.time) minutes")
print("Elevation: \(secondRun.elevation) meters")
