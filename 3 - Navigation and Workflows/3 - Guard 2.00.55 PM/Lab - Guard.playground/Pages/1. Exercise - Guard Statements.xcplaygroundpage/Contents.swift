...
print(calculateArea(x: 20, y: 10) ?? "Negative operand")
print(calculateArea(x: 20, y: -10) ?? "Negative operand")
...
print(add(x: 3, y: 5) ?? "Addition not possible")
print(add(x: nil, y: 5) ?? "Addition not possible")
...
firstNameTextField.text = "Mahi"
lastNameTextField.text = "Awasthi"
