...
//print("The value of foo is \(foo)")
print("Because foo is defined within a loop, it is not accessible outside of the loop")
...
print("x is defined in the global scope and modified within the loop")
...
greeting(greeting: "Hi there", name: "Mahi")
greeting(greeting: nil, name: "Mahi")
