...
let intergerDivisionResult: Int = 10/3
...
// for Int it will show round off value and exact value for double type
/*:
 ...
 */
let pi = 3.1415927 
let diameter: Double=2*5.0
let circumference: Double=2*pi*5.0

print("Diameter: \(diameter) and Circumference: \(circumference)")
